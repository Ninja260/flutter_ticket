...
import 'package:ticket/pages/landing_check.dart';
...
import 'ticket/ticket_details_page.dart';
import 'ticket/list_page.dart';
      ...
      builder: (BuildContext context, Widget? child) {
        return MultiProvider(
          providers: [
            ...
            ChangeNotifierProvider(
              create: (context) => TicketListPageVM(),
            ),
          ],
          child: MaterialApp(
              ...
              return MaterialPageRoute<void>(
                ...
                builder: (BuildContext context) {
                  switch (routeSettings.name) {
                    ...
                    case TicketListPage.routeName:
                      return const TicketListPage();
                    case TicketFormPage.routeName:
                      return const TicketFormPage();
                    case LoginPage.routeName:
                      return const LoginPage();
                    default:
                      return const LandingCheckPage();
                  }
                },
              );
            },
